    ...
    return (
        <div className="overflow-scroll dynamicHeight flex flex-col flex-grow p-[1.25rem] pb-12 w-full">
            ...
            <div className="flex flex-col items-center mt-8">
                {/* App Logo */}
                <div className="w-16 h-16 bg-[#5D3A96] rounded-xl flex items-center justify-center">
                    <img src="/sentinel_logo.png" alt="Trade Sentinel Logo" className="w-10 h-10" />
                </div>
                ...
                <div className="bg-white rounded-xl overflow-hidden">
                    ...
                    >
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                <span className="text-sm text-[#121926] font-bold">Ay Dot</span>
                                <span className="text-sm text-[#121926]"> (Frontend Dev)</span>
                            </div>
                        </div>
                        <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M8.33366 5.8335L11.667 10.0002L8.33366 14.1668" stroke="#28303F" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
